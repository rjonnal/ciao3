...
class DM(object):
    ...
    def __init__(self, serialNumber):
        ...
        _asdk311.DM_swiginit(self, _asdk311.new_DM(serialNumber))
    __swig_destroy__ = _asdk311.delete_DM

    def Reset(self):
        r"""Reset(DM self) -> acs::COMPL_STAT"""
        return _asdk311.DM_Reset(self)

    def Stop(self):
        r"""Stop(DM self) -> acs::COMPL_STAT"""
        return _asdk311.DM_Stop(self)
    ...
    def Send(self, *args):
        ...
        """
        return _asdk311.DM_Send(self, *args)
    ...
    def SendOne(self, arg2, arg3, arg4, arg5):
        ...
        return _asdk311.DM_SendOne(self, arg2, arg3, arg4, arg5)
    ...
    def Set(self, *args):
        ...
        """
        return _asdk311.DM_Set(self, *args)

    @staticmethod
    def Check():
        r"""Check() -> acs::Bool"""
        return _asdk311.DM_Check()

    @staticmethod
    def GetLastError():
        r"""GetLastError() -> acs::UInt"""
        return _asdk311.DM_GetLastError()

    def __str__(self):
        r"""__str__(DM self) -> char *"""
        return _asdk311.DM___str__(self)

# Register DM in _asdk311:
_asdk311.DM_swigregister(DM)
...
def __lshift__(arg1, arg2):
    ...
    return _asdk311.__lshift__(arg1, arg2)
